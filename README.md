...
An intelligent Discord bot built with Deno.
...
> [!WARNING]
> [Deno](https://deno.com/) version required: 2.5.x or higher

## Scripts

- `compile`: compile an executable
...
- [Rincko](https://constatic-docs.vercel.app/pt) for discord bot base
