...
import { Constatic } from "./app.ts";
import { baseErrorHandler } from "./base.error.ts";
import { runtimeDisplay } from "./base.version.ts";
import { BaseCommandHandlers } from "./commands/handlers.ts";
import "./constants.ts";
import { BaseEventHandlers } from "./events/handlers.ts";
import { BaseResponderHandlers } from "./responders/handlers.ts";
